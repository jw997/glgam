...
wikipediaMap.set("AIA", ["ATG","VGB","NLD","BLM",/*"FRA",*/"VIR","MAF"]);
...
wikipediaMap.set("ATF", ["AUS","MOZ","MDG","HMD","MUS","COM"]);
//wikipediaMap.set("ATF", ["COM","FRA","MDG","MUS","SYC","HMD"]);
wikipediaMap.set("ATG", ["FRA","KNA","AIA","MSR","FRA","BLM"]);
...
wikipediaMap.set("BLM", ["ATG","NLD","KNA","AIA",/*"FRA",*/"SXM","MAF"]);
...
wikipediaMap.set("CYP", ["EGY","GRC","PSE","ISR","LBN","SYR","TUR"]);
...
wikipediaMap.set("FLK", ["ARG","SGS","ATA"]);

wikipediaMap.set("FRA", ["AND","ATG","BRB","BEL","BRA","COM","DMA","DEU","ITA","LUX","MCO","MDG","MUS","LCA","ESP","CHE","SUR","GBR","VEN","GGY","JEY","MSR"]);
wikipediaMap.set("FRO", ["ISL","NOR","GBR"]);
wikipediaMap.set("FSM", ["MHL","PLW","PNG","GUM"]);
wikipediaMap.set("GAB", ["CMR","COG","GNQ","STP"]);
wikipediaMap.set("GBR", ["BEL","DNK","FRA","DEU","IRL","NLD","NOR","FRO","GGY","IMN"]);
...
wikipediaMap.set("HND", ["BLZ","CUB","GTM","JAM","MEX","NIC","CYM","SLV"]);
wikipediaMap.set("HRV", ["BIH","HUN","ITA","MNE","SRB","SVN"]);
wikipediaMap.set("HTI", ["BHS","COL","CUB","DOM","TCA","JAM"]);
...
wikipediaMap.set("KAZ", ["AZE","CHN","KGZ","RUS","UZB","TKM"]);
wikipediaMap.set("KEN", ["ETH","SOM","SSD","UGA","TZA"]);
...
wikipediaMap.set("LBY", ["DZA","TCD","EGY","GRC","ITA","MLT","NER","SDN","TUN"]);
wikipediaMap.set("LCA", ["BRB","FRA","VCT","VEN"]);
wikipediaMap.set("LIE", ["AUT","CHE"]);
wikipediaMap.set("LKA", ["IND","MDV"]);
wikipediaMap.set("LSO", ["ZAF"]);
wikipediaMap.set("LTU", ["LVA","POL","RUS","SWE","BLR"]);
wikipediaMap.set("LUX", ["BEL","FRA","DEU"]);
wikipediaMap.set("LVA", ["EST","LTU","BLR","RUS","SWE"]);
wikipediaMap.set("MAC", ["CHN","HKG"]);
wikipediaMap.set("MAF", ["AIA","BLM","SXM","NLD"]);
...
wikipediaMap.set("MEX", ["CUB","GTM","HND","USA","BLZ"]);
...
wikipediaMap.set("MNE", ["BIH","HRV","ITA","SRB","XKX","ALB"]);
wikipediaMap.set("MNG", ["CHN","RUS"]);
wikipediaMap.set("MNP", ["GUM","JPN"]);
wikipediaMap.set("MOZ", ["SWZ","MDG","MWI","TZA","ZMB","ZWE","ATF","ZAF","COM"]);
...
wikipediaMap.set("MYS", ["CHN","IDN","PHL","SGP","VNM","TWN","THA","BRN"]);
wikipediaMap.set("NAM", ["BWA","ZMB","AGO","ZAF"]);
wikipediaMap.set("NCL", ["FJI","SLB","VUT","NFK","AUS"]);
wikipediaMap.set("NER", ["DZA","BEN","BFA","TCD","LBY","MLI","NGA"]);
wikipediaMap.set("NFK", ["NZL","NCL"]);
wikipediaMap.set("NGA", ["CMR","TCD","NER","STP","GNQ","BEN"]);
wikipediaMap.set("NIC", ["CRI","SLV","JAM","PAN","HND","COL"]);
...
wikipediaMap.set("NOR", ["DNK","FIN","RUS","SWE","GBR"/*"SJM"*/,"FRO",]);
wikipediaMap.set("NPL", ["IND","CHN"]);
wikipediaMap.set("NRU", ["KIR","MHL"]);

wikipediaMap.set("NZL", ["AUS","FJI","NFK"]);
...
wikipediaMap.set("PLW", ["IDN","PHL","FSM"]);
wikipediaMap.set("PNG", ["AUS","IDN","SLB","FSM"]);
wikipediaMap.set("POL", ["BLR","CZE","DNK","DEU","LTU","RUS","SVK","SWE","UKR"]);
wikipediaMap.set("PRI", ["DOM","VEN","VGB","VIR"]);
wikipediaMap.set("PRK", ["CHN","KOR","RUS"]);
...
wikipediaMap.set("SLB", ["FJI","PNG","VUT","NCL","AUS"]);
...
wikipediaMap.set("VCT", ["BRB","LCA","TTO","VEN","GRD"]);
